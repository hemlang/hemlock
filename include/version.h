...
#define HEMLOCK_VERSION_MINOR 10
#define HEMLOCK_VERSION_PATCH 0

#define HEMLOCK_VERSION "1.10.0"
#define HEMLOCK_VERSION_STRING "Hemlock v" HEMLOCK_VERSION

/*
 * Version history:
 *   1.10.0 - Reduce builtin conflicts: move math, env, signal, socket, and net builtins to stdlib modules
