...
HmlValue hml_string_byte_ptr(HmlValue str); // Returns raw pointer to string bytes
...
void hml_object_set_field_coerce(HmlValue obj, HmlValue key, HmlValue val);  // Non-string key auto-coerced to string
...
HmlValue hml_lws_http_get_timeout_with_headers(HmlValue url, HmlValue timeout_ms, HmlValue headers);
...
HmlValue hml_lws_http_stream_read_binary(HmlValue stream, HmlValue timeout_ms);
