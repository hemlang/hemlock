 ...
 *
 * This file implements additional builtin functions:
 ...
 * - Memory operations
 * - Object operations
 * - Exception handling and defer
 * - Function calls
 * - File I/O
 * - Signal handling
 * - Type definitions
 *
 * Core builtins (print, typeof, assert, panic, type checking)
 * are implemented in builtins_core.c
 */
