...
WASM_INTERP_LDFLAGS = \
	...
	-sSTACK_SIZE=1048576 \
	-sUSE_ZLIB=1 \
	-sEXPORTED_FUNCTIONS='["_main","_hemlock_eval","_hemlock_version","_hemlock_context_create","_hemlock_context_eval","_hemlock_context_destroy","_hemlock_context_get","_hemlock_context_set","_malloc","_free"]' \
