...
WASM_INTERP_LDFLAGS = \
	...
	-sSTACK_SIZE=1048576 \
	-sUSE_ZLIB=1 \
	-sEXPORTED_FUNCTIONS='["_main","_hemlock_eval","_hemlock_version","_hemlock_context_create","_hemlock_context_eval","_hemlock_context_destroy","_hemlock_context_get","_hemlock_context_set","_hemlock_compile_script","_hemlock_run_script","_hemlock_free_script","_malloc","_free"]' \
