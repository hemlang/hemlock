...
Value call_string_method(String *str, const char *method, Value *args, int num_args, ExecutionContext *ctx) {
    ...
    case 'b':
        ...
        if (method[1] == 'y' && method[2] == 't' && method[3] == 'e' && method[4] == '_' && strcmp(method, "byte_at") == 0) {
            if (num_args != 1) {
    ...
    case 'c':
        ...
        if (method[1] == 'o' && strcmp(method, "contains") == 0) {
            if (num_args != 1) {
        ...
        if (method[1] == 'h' && method[2] == 'a' && method[3] == 'r' && method[4] == '_' && strcmp(method, "char_at") == 0) {
            if (num_args != 1) {
        ...
        if (method[1] == 'h' && method[2] == 'a' && method[3] == 'r' && method[4] == 's' && strcmp(method, "chars") == 0) {
            if (num_args != 0) {
    ...
    case 'r':
        ...
        if (method[1] == 'e' && method[2] == 'p' && method[3] == 'l' && strcmp(method, "replace_all") == 0) {
            if (num_args != 2) {
        ...
        if (method[1] == 'e' && method[2] == 'p' && method[3] == 'e' && strcmp(method, "repeat") == 0) {
            if (num_args != 1) {
    ...
    case 's':
        ...
        if (method[1] == 'p' && strcmp(method, "split") == 0) {
            if (num_args != 1) {
        ...
        if (method[1] == 't' && strcmp(method, "starts_with") == 0) {
            if (num_args != 1) {
